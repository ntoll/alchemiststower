...
cards = [
    ...
    Card("intro2", sound="music/opening_chords.mp3", auto_advance=2, auto_target="intro2b"),
    ...
    ], sound="sfx/lake.mp3", sound_repeat=True),
    ...
    sound="music/solo_violin.mp3", auto_advance=20,
    ...
    Card("walls", background="img/walls.png", buttons=[
        ...
        {"label": "▶", "target": "undergrowth"},
    ], sound="sfx/woods.mp3", sound_repeat=True),
    ...
    sound="music/chords_and_stopping.mp3"),
    ...
    Card("interview_end", text_size=text_size, text="The old man broke into a smile.\n\n\"Correct!\", he exclaimed.\n\nWith that, he stood up and walked through the woods in the direction of the tower.", sound="sfx/gravel_steps.mp3",
    ...
    Card("front_courtyard", background="img/front_door_out.png",
        sound="sfx/nature.mp3", sound_repeat=True, buttons=[
            {"label": "▲", "target": to_front_door},
            {"label": "▼", "target": "back_courtyard"},
            {"label": "▶", "target": "small_tower_door"},
        ]),
    Card("back_courtyard", background="img/arches.png",
        sound="sfx/fireplace.mp3", sound_repeat=True, buttons=[
    ...
    Card("stairs", background="img/fireplace.png",
         sound="sfx/ticking.mp3", sound_repeat=True, buttons=[
            {"label": "◀", "target": "basin"},
    ...
    Card("window_reeds", background="img/window_reeds.png",
         sound="sfx/lake.mp3", sound_repeat=True, buttons=[
            {"label": "▼", "target": "under_arch"},
         ]),
    ...
    Card("book_lock",
        ...
        form=Inputs.TEXTBOX, buttons=[
            ...
            {"label": "▼", "target": "window_view"},
        ], sound="sfx/ticking.mp3", sound_repeat=True),
    Card("locked",
         text_size=text_size,
         text="{message}",
         auto_advance=3,
    ...
    Card("red1", 
         ...
         auto_advance=30,
         auto_target="red2",
         sound="music/violin_and_chords.mp3",
         sound_repeat=True),
    Card("red2", 
    ...
    Card("instruct",
         ...
         sound="music/chords_and_arpeggios.mp3"),
    Card("instruct2",
    ...
    Card("finale",
         ...
         auto_advance=9,
         auto_target="finale2",
         sound="music/chords_and_harmonics.mp3"),
    Card("finale2",
         background="img/jung.png",
         auto_advance=9,
         auto_target="finale3"),
